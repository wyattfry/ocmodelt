 ...
 */
function tasman_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function tasman_sanitize_css( $css ) {
 ...
 */
function tasman_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function tasman_sanitize_email( $email, $setting ) {
 ...
 */
function tasman_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function tasman_sanitize_html( $html ) {
 ...
 */
function tasman_sanitize_image( $image, $setting ) {
 ...
 */
function tasman_sanitize_nohtml( $nohtml ) {
 ...
 */
function tasman_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function tasman_sanitize_number_range( $number, $setting ) {
 ...
 */
function tasman_sanitize_select( $input, $setting ) {
 ...
 */
function tasman_sanitize_url( $url ) {
